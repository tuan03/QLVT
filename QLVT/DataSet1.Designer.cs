...
SELECT MasoDDH, MAVT, SOLUONG, DONGIA FROM CTDDH WHERE (MAVT = @MAVT) AND (MasoDDH = @MasoDDH)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT MasoDDH, MAVT, SOLUONG, DONGIA \r\nFROM CTDDH d\r\nWHERE MasoDDH = @MasoDDH\r\nA" +
                "ND NOT EXISTS (\r\n    SELECT 1\r\n    FROM CTPN p\r\n    WHERE p.MAPN = @MAPN\r\n    AN" +
                "D p.MAVT = d.MAVT\r\n);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MasoDDH", global::System.Data.SqlDbType.NChar, 8, global::System.Data.ParameterDirection.Input, 0, 0, "MasoDDH", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MAPN", global::System.Data.SqlDbType.NVarChar, 8, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByMaSoDDH(DataSet.CTDDHDataTable dataTable, string MasoDDH, string MAPN) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((MasoDDH == null)) {
                throw new global::System.ArgumentNullException("MasoDDH");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(MasoDDH));
            }
            if ((MAPN == null)) {

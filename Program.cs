...
namespace QLTVT
{
    ...
    */
    static class Program
    {
        ...
        public static String connstrPublisher = "Data Source=LTH-KARINA-PC;Initial Catalog=QLVT;Integrated Security=true";
        ...
        public static String remotePassword = "12345";//remotepassword //đã sửa bởi lthloi
